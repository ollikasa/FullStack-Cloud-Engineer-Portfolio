      ...
      <section className="section">
        <div className="container">
          <SectionTitle
            ...
            description={
              profile?.bio ||
              "My journey combines computer engineering, software development, networking, cloud infrastructure and automation."
            }
          />
          ...
          <div className="about-grid">
            <div>
              <p>
                {profile?.bio ||
                  "I am a Computer Engineering graduate interested in building reliable software and infrastructure systems."}
              </p>
            ...
            <div className="info-box">
              <div>
                <span>Location</span>
                <strong>{profile?.location || "Addis Ababa, Ethiopia"}</strong>
              </div>
